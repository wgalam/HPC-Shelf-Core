...
/**
 * <p>Classe Java de cost_function_type complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="function_parameters" type="{http://storm.lia.ufc.br}cost_function_term_type" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "cost_function_type", propOrder = {
    "functionParameters",
    "functionArguments"
})
public class CostFunctionType {

    @XmlElement(name = "function_parameters")
    protected List<CostFunctionTermType> functionParameters;
     ...
     * {@link CostFunctionTermType }
     * 
     * 
     */
    public List<CostFunctionTermType> getFunctionParameters() {
        if (functionParameters == null) {
            functionParameters = new ArrayList<CostFunctionTermType>();
        }
