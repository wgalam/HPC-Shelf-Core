...
/**
 * <p>Classe Java de ranking_function_type complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="function_parameters" type="{http://storm.lia.ufc.br}ranking_function_term_type" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "ranking_function_type", propOrder = {
    "functionParameters",
    "functionArguments"
})
public class RankingFunctionType {

    @XmlElement(name = "function_parameters")
    protected List<RankingFunctionTermType> functionParameters;
     ...
     * {@link RankingFunctionTermType }
     * 
     * 
     */
    public List<RankingFunctionTermType> getFunctionParameters() {
        if (functionParameters == null) {
            functionParameters = new ArrayList<RankingFunctionTermType>();
        }
